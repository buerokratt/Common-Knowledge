  ...
  const columns: ColumnDef<KnowledgeBaseItem>[] = [
    {
      ...
      cell: ({ row }) => (
        <div className="knowledge-base__agency-cell">{row.original.agency}</div>
      ),
    },
    {
      accessorKey: 'domain',
      header: t('knowledgeBase.domain'),
      enableColumnFilter: false,
    },
    {
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <Track gap={16} justify="end">
          <Button appearance="text" onClick={() => handleEdit(row.original)}>
          ...
          >
            <Icon icon={<MdOutlineDeleteOutline />} size="medium" />
            {t('global.delete')}
          </Button>
        </Track>
      ),
    ...
    <div className="knowledge-base">
      <Track style={{ marginBottom: 16 }} justify="between" align="center">
        ...
        <Track gap={12}>
          ...
          >
            {/* <Icon icon={<MdUpload />} size="medium" /> */}
          ...
          <Button
            ...
            onClick={() => setAddApiModal(true)}
          >
            {/* <Icon icon={<MdApi />} size="medium" /> */}
            {t('knowledgeBase.addApi')}
          </Button>
          <Button appearance="primary" onClick={() => setAddUrlModal(true)}>
            {/* <Icon icon={<MdLink />} size="medium" /> */}
      ...
      <Card>
        ...
        <div className="knowledge-base__footer">
          <span className="knowledge-base__total">
