...
def catch_error(url: str, spider: BaseSpider) -> Generator[None, None, None]:
    try:
        yield
...
def catch_error_spider(f: Callable[..., object]) -> Callable[..., object]:
    @functools.wraps(f)
